...
class HealthTheme {
  // Colors
  static Color get primaryColor => const Color(0xFF10B981);
  static Color get secondaryColor => const Color(0xFF64748B);
  static Color get successColor => const Color(0xFF059669);
  static Color get dangerColor => const Color(0xFFEF4444);
  static Color get warningColor => const Color(0xFFF59E0B);
  static Color get backgroundColor => const Color(0xFFF0FDF4);
